...
class YellowCatalan {
    ...
    public function onLoad($yellow) {
        ...
        $this->yellow->language->setDefaults(array(
            ...
            "ChineseDescription: Idioma xinès.",
            ...
            "ContactStatusIncomplete: Si us plau omple tots els camps.",
            ...
            "ContactStatusError: L'email no ha pogut ser enviat, si us plau intenta-ho més tard.",
            ...
            "Descripció txeca: Llengua txeca.",
            ...
            "Descripció holandesa: Idioma holandès.",
            ...
            "EditSignupConsent: Doneu el meu consentiment per a aquest lloc web almacene mis dades personals.",
            ...
            "EditForgotTitle: Has oblidat lacontrasenya",
            ...
            "EnglishDescription: Idioma anglès.",
            ...
            "GermanDescription: Idioma alemany.",
            ...
            "HungarianDescription: Idioma hongarès.",
            ...
            "InstallExtensionBlog: bloc petit",
            "InstallExtensionWiki: Petit wiki",
            "InstallButton: Instal·lar",
            "InstallHomeTitle: Inici",
            "InstallHomeText: [image photo.jpg Exemple arrodonit]\\n\\n[editar - Podeu editar aquesta pàgina en un navegador web] o utilitzar un editor de text. [Consulteu ajuda](https://datenstrom.se/yellow /ajuda/).",
            ...
            "ItalianDescription: Idioma italià.",
            "JapaneseDescription: Idioma japonès.",
            "MarkdownDescription: Format de text per a humans.",
            "MetaDescripció: Metadades per a humans i màquines.",
            "NorwegianDescription: Idioma noruec.",
