...
class YellowRussian {
    ...
    public function onLoad($yellow) {
        ...
        $this->yellow->language->setDefaults(array(
            ...
            "AnchorDescription: Показывать ссылки-якоря рядом с заголовками.",
            ...
            "HelpDescription: Документирование основных положений.",
            "HighlightDescription: Выделите блоки кода.",
            ...
            "UpdateExtensionDefaultResponsible: Разработчик неизвестен.",
