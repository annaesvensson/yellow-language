...
class YellowPortuguese {
    ...
    public function onLoad($yellow) {
        ...
        $this->yellow->language->setDefaults(array(
            ...
            "AudioDescription: Reprodutor de áudio HTML5.",
            ...
            "CsvDescription: Analisador de arquivo CSV.",
            "CzechDescription: Idioma Tcheco.",
            "DailyDescription: Mostrar páginas diárias.",
            ...
            "PodcastDescription: Web feed otimizado para publicação de podcast.",
            ...
            "RadiobossDescription: Widgets para RadioBoss Cloud.",
            "RandomDescription: Exibir páginas aleatórias.",
            "ReadingtimeDescription: Mostrar tempo de leitura estimado para o conteúdo da página.",
            "RedirectDescription: Redirecionamento de página alternativo.",
            ...
            "SoundcloudDescription: Incorporar faixas de áudio do Soundcloud.",
            "SpanishDescription: Idioma Espanhol.",
            "SpoilerDescription: Ocultar determinados elementos da página.",
            "StockholmDescription: Stockholm é um tema limpo.",
            "SwedishDescription: Idioma Sueco.",
            "TickerDescription: Analisador de feed RSS.",
            ...
            "TwitterDescription: Incorporar mensagens do Twitter.",
            ...
            "YoutubeDescription: Incorporar vídeos do Youtube."));
    }
