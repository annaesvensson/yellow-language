...
class YellowSpanish {
    ...
    public function onLoad($yellow) {
        ...
        $this->yellow->language->setDefaults(array(
            ...
            "AnchorDescription: Mostrar enlaces de anclaje junto a los títulos.",
            ...
            "ContactDescription: Formulario de contacto para enviar correos electrónicos.",
            "ContactName: Nombre:",
            "ContactEmail: Email:",
            ...
            "EnglishDescription: Idioma inglés.",
            ...
            "MarkdownDescription: Formato de texto para humanos.",
            ...
            "ParsedownDescription: Formato de texto para humanos.",
            ...
            "UpdateExtensionDefaultDescription: No hay descripción disponible.",
            "UpdateExtensionDefaultResponsible: Se desconoce quién es el desarrollador.",
            "UpdateExtensionDeveloper: Desarrollado por @x.",
            "UpdateExtensionDesigner: Diseñado por @x.",
