...
class YellowJapanese {
    ...
    public function onLoad($yellow) {
        ...
        $this->yellow->language->setDefaults(array(
            ...
            "AnchorDescription: 見出しの横にアンカーリンクを表示する。",
            ...
            "UpdateExtensionDefaultResponsible: 開発者は不明です。",
