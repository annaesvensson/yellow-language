...
class YellowJapanese {
    ...
    public function onLoad($yellow) {
        ...
        $this->yellow->language->setDefaults(array(
            ...
            "AudioDescription: HTML5 オーディオ プレーヤー。",
            "BerlinDescription: ベルリンは Dieter Rams にインスパイアされたテーマです。",
            ...
            "HelloworldDescription: アニメーション テキストを作成します。",
            ...
            "StockholmDescription: ストックホルムはクリーンなテーマです。",
