...
class YellowTurkish {
    ...
    public function onLoad($yellow) {
        ...
        $this->yellow->language->setDefaults(array(
            ...
            "AnchorDescription: Başlıkların yanında bağlantı bağlantılarını göster.",
            ...
            "EnglishDescription: İngilizce dili.",
            ...
            "UpdateDescription: Eklentilerinizi güncel tutun.",
            "UpdateExtensionDefaultDescription: Açıklama mevcut değil.",
            "UpdateExtensionDefaultResponsible: Geliştirici bilinmiyor.",
